...
export const metadata = {
  title: 'Peta Interaktif | Nusantara Chronicles',
  description: 'Jelajahi kekayaan budaya dan tradisi dari berbagai wilayah di Indonesia.',
};
...
export default function ExplorePage() {
  ...
  return (
    <div className="bg-background">
      <section className="py-20 sm:py-32 text-center container">
        <AnimatedWrapper>
      ...
      <section className="py-12 bg-background/50">
        <div className="container">
          <h2 className="text-3xl font-bold text-center mb-12 font-headline">Jelajahi Berdasarkan Wilayah</h2>
